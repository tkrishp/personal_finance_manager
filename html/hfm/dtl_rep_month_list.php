...
<body>
	...
	<div id="content">
		...
		<ul class="pageitem">		
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_01_jan_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_02_feb_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_03_mar_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_04_apr_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_05_may_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_06_jun_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_07_jul_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_08_aug_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_09_sep_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_10_oct_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_11_nov_val.php">
			...
			<li class="menu">
				<a href="/hfm/reports/dtl/dtl_rep_12_dec_val.php">
