...
<body>
	...
	<div id="content">
		...
		<ul class="pageitem">		
			...
			<li class="textbox">
				<span class="header">Choose # of weeks</span>
			</li>
					
			<li class="menu">
				<a href="/hfm/reports/summ_rep_7wkly_val.php">
					<span class="name">Last 7 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>

			<li class="menu">
				<a href="/hfm/reports/summ_rep_8wkly_val.php">
					<span class="name">Last 8 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>

			<li class="menu">
				<a href="/hfm/reports/summ_rep_9wkly_val.php">
					<span class="name">Last 9 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>

			<li class="menu">
				<a href="/hfm/reports/summ_rep_10wkly_val.php">
					<span class="name">Last 10 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>
			
			<li class="menu">
				<a href="/hfm/reports/summ_rep_11wkly_val.php">
					<span class="name">Last 11 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>

			<li class="menu">
				<a href="/hfm/reports/summ_rep_12wkly_val.php">
					<span class="name">Last 12 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>		
