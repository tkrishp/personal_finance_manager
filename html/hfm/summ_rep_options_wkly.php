...
<body>
	...
	<div id="content">
		...
		<ul class="pageitem">		
			...
			<li class="menu">
				<a href="/hfm/reports/summ_rep_2wkly_val.php">
					<span class="name">Last 2 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>

			<li class="menu">
				<a href="/hfm/reports/summ_rep_3wkly_val.php">
					<span class="name">Last 3 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>

			<li class="menu">
				<a href="/hfm/reports/summ_rep_4wkly_val.php">
					<span class="name">Last 4 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>

			<li class="menu">
				<a href="/hfm/reports/summ_rep_5wkly_val.php">
					<span class="name">Last 5 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>
			
			<li class="menu">
				<a href="/hfm/reports/summ_rep_6wkly_val.php">
					<span class="name">Last 6 weeks</span>
					<span class="arrow"></span>
				</a>
			</li>

			<li class="menu">
				<a href="/hfm/summ_rep_options_wkly2.php">
