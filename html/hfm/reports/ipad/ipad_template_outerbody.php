...
<BODY>
	<DIV id=wrap>
		<DIV id=main>
			<DIV class=header>
				<A class=left href="http://xaviesteve.com/pro/ipad-template/?">Back</A>
				<H1 class=title>Section title</H1><A class=right href="http://xaviesteve.com/pro/ipad-template/?">Edit</A>
			</DIV><!--header-->
	...
	<DIV class=content>
		...
		<DIV class=box-white>
			<P>
				Lorem ipsum <SPAN class=detail>Details here</SPAN>
				<SPAN>Dolor</SPAN>
			</P>
		</DIV><!--box-white-->
		...
		<DIV class=content>
			<div data-role="content">
				<ul data-role="listview" data-theme="g">
						<li><a href="/hfm/form1.php">Data Entry</a></li>
				...
				<div data-role="collapsible" data-mini="true" data-content-theme="c" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" data-iconpos="right">
					<h3>Reports</h3>
					<div data-role="collapsible" data-mini="true" data-content-theme="c"><h3><a href="template.php" data-transition="flip">Summary Report</a></h3></div>
					<div data-role="collapsible" data-mini="true" data-content-theme="c"><h3><a href="collapsible.php" data-transition="flip">Drill-Down Report</a></h3></div>
				</div>

				<div data-role="collapsible" data-mini="true" data-content-theme="c" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" data-iconpos="right">
					<h3>Reports with list view</h3>
						<div data-role="content">
							<ul data-role="listview" data-theme="g" data-mini="true">
								<li><a href="template.php" data-transition="flip">Summary Report</a></li>
								<li><a href="collapsible.php" data-transition="flip">Drill-Down Report</a></li>
							</ul>
						</div>
				</div>
